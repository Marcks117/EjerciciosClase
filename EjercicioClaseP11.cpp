...
//*****	Práctica 11 Ejercicio de Clase 	    ******************//
...
typedef struct _frame
{
	...
	float rotRodIzq;
	float rotRodDer; //Variable para la pierna derecha
	float rotInc;
	float rotRodDerInc; //Variable para la pierna derecha incremento
	float giroMonito;
	float giroMonitoInc;
	float BrazoDerInc;
	float BrazoIzqInc;
