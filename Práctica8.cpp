...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_metal01.LoadTGA("Cubo.tga");  // Encointrar textura
	t_metal01.BuildGLTexture();		// Agregar textura
	t_metal01.ReleaseImage();		// Dibujar textura
...
void prisma (GLuint textura1, GLuint textura2)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
		...
		glBegin(GL_POLYGON);	//Front
			...
			glTexCoord2f(0.50f, 0.33f); glVertex3fv(vertice[0]);//10
			glTexCoord2f(0.50f, 0.66f); glVertex3fv(vertice[4]);//11
			glTexCoord2f(0.25f, 0.66f); glVertex3fv(vertice[7]);//01
			glTexCoord2f(0.25f, 0.33f); glVertex3fv(vertice[1]);//00
		glEnd();
		...
		glBegin(GL_POLYGON);	//Right
			...
			glTexCoord2f(0.50f, 0.66f); glVertex3fv(vertice[5]);
			glTexCoord2f(0.50f, 0.33f); glVertex3fv(vertice[4]);
		glEnd();

		glBegin(GL_POLYGON);	//Back
			glNormal3f( 0.0f, 0.0f,-1.0f);
			glTexCoord2f(1.0f, 0.35f); glVertex3fv(vertice[6]);
			glTexCoord2f(1.0f, 0.66); glVertex3fv(vertice[5]);
			glTexCoord2f(0.75f, 0.66f); glVertex3fv(vertice[3]);
			glTexCoord2f(0.75f, 0.35); glVertex3fv(vertice[2]);
		glEnd();

		glBegin(GL_POLYGON);  //Left
			glNormal3f(-1.0f, 0.0f, 0.0f);
			glTexCoord2f(0.250f, 0.33f); glVertex3fv(vertice[1]);
			glTexCoord2f(0.250f, 0.66f); glVertex3fv(vertice[7]);
		...
		glBegin(GL_POLYGON);  //Bottom
			...
			glTexCoord2f(0.50f, 0.0f); glVertex3fv(vertice[0]);
			glTexCoord2f(0.50f, 0.33f); glVertex3fv(vertice[1]);
...
//		glBindTexture(GL_TEXTURE_2D, textura2);   // choose the texture to use.
		glBegin(GL_POLYGON);  //Top
			glNormal3f( 0.0f, 1.0f, 0.0f);
			glTexCoord2f(0.5f, 0.66f); glVertex3fv(vertice[4]);//11
			glTexCoord2f(0.5f, 1.0f); glVertex3fv(vertice[5]);//10
			glTexCoord2f(0.25f, 1.0f); glVertex3fv(vertice[6]);//01
			glTexCoord2f(0.25f, 0.66f); glVertex3fv(vertice[7]);//00
		glEnd();
}
